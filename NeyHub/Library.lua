...
local CustomImageManagerAssets = {
    TransparencyTexture = {
        ...
        Path = "NeyHub/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "NeyHub/assets/SaturationMap.png",
    ...
    LoadingIcon = {
        ...
        Path = "NeyHub/assets/LoadingIcon.png",
    ...
    CheckIcon = {
        ...
        Path = "NeyHub/assets/CheckIcon.png",
...
do
    ...
    function CustomImageManager.AddAsset(
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("NeyHub/custom_assets/%s", AssetName),
            URL = URL,
...
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
    warn("NeyHub:MakeOutline is deprecated, please use NeyHub:AddOutline instead.")
